...
- How does heart rate vary over time?
- Are there identifiable patterns or anomalies in the data?
- How does heart rate respond to different conditions or behaviours?


This project highlights core data analysis skills, including:
...
It was developed using Python, Matplotlib, Pandas, and Jupyter Notebook.
